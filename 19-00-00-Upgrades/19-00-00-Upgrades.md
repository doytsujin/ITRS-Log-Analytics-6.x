...
```bash
yum update itrs-log-analytics-client-node-6.1.8-1.x86_64.rpm
yum update itrs-log-analytics-data-node-6.1.8-1.x86_64.rpm
```
...
1. Client Node
		...
		yum install itrs-log-analytics-client-node-6.1.7-1.x86_64.rpm

	In case of an error:

		Transaction check error:
		  file /usr/lib/python2.7/site-packages/urllib3/packages/ssl_match_hostname from install of python-urllib3-1.10.2-7.el7.noarch conflicts with file from package itrs-log-analytics-client-node-6.1.6-1.x86_64
...
1. Data Node
		...
		yum install itrs-log-analytics-data-node-6.1.7-1.x86_64.rpm
