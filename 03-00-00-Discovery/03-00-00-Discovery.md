...
range of time that ITRS will search in terms of conditions contained in
...
### Operators ###
The search language used in ITRS allows to you use logical operators
...
-   **OR** is used to search for the events that contain one OR other
   ...
   events that contain word „denied" or status field value of 500. ITRS
